...
import { IsActiveContainer, MainModalContainer, RentHistoryContainer } from './MainModalStyled';
          ...
          <div className="main-content">
            ...
            <div className="text-side">
              <div className="text">
                ...
                <Typography variant="body1">{new Date(book.systemEntryDate).toLocaleDateString('pt-br')}</Typography>
              </div>
              <div className="buttons">
                ...
                <Button variant="outlined" onClick={() => controlModal('main', 'rentHistory')} sx={{ color: 'black' }}>
                  Histórico
                </Button>
              </div>
            </div>
