...
const AllRentHistory = () => {
    ...
    useEffect(() => {
        ...
        const filteredRent = allRents?.filter((row) => {
            if (
                studentNameFilter &&
                !simplify(row.studentName).includes(simplify(studentNameFilter))
            )
                return false

            if (
                classFilter &&
                !simplify(row.class).includes(simplify(classFilter))
            )
                return false

            if (
                tittleFilter &&
                !simplify(row.tittle).includes(simplify(tittleFilter))
            )
                return false
                    ...
                    <TableRow>
                        ...
                        <TableCell>
                            <TextField
                                ...
                                name="tittle"
                                onChange={(e) =>
                                    setTittleFilter(e.target.value)
                                }
                                variant="standard"
                                sx={{ width: '105px' }}
                                InputProps={{
                        ...
                        <TableCell>
                            <TextField
                                ...
                                name="withdrawalDate"
                                onChange={(e) =>
                                    setWithdrawalDateFilter(e.target.value)
                                }
                                variant="standard"
                                sx={{ width: '105px' }}
                                InputProps={{
